...
@Setter
@Entity
@Table(name = "storage_max_energy_constraint", indexes = {@Index(name = "idx_storage_max_energy_constraint_revision_id", columnList = "revision_id")})
public class StorageMaxEnergyConstraint extends TimeWindowConstraint {
